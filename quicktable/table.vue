...
//                    const width = this.bodyHeight === 0 ? this.tableWidth : this.tableWidth - this.scrollBarWidth;
        ...
        methods: {
            ...
            handleMouseIn (_index) {
                ...
                if (this.objData[_index] && this.objData[_index]._isHover) return;
            ...
            eventAnimation(event){
                ...
                this.tableDataIndex = parseInt((event.target.scrollTop % (this.moduleNumber*this.rowHeight*3)) / (this.rowHeight*this.moduleNumber));
            ...
            handleBodyScroll (event) {
                ...
                // //     if(this.tableDataIndex*20>=this.rebuildData.length){
                // //         // console.log(this.tableDataIndex,"tableDataIndex",event)
                // //         return;
                // //     }
                // //     this.tableDataIndex++;
                // //     console.log('已经到最底部');
                ...
                // //module's index 
                // // console.log(event.target.scrollTop/this.moduleHeight,"table.vue",this.moduleHeight)
                // // this.tableDataIndex = Math.ceil(event.target.scrollTop/(this.moduleHeight-48*20))
                // this.hideColumnFilter();
                // this.tableDataIndex = window.requestAnimationFrame( parseInt((event.target.scrollTop % (this.moduleNumber*this.rowHeight*3)) / (this.rowHeight*this.moduleNumber)));
            },
            ...
            moduleHeight(){
                this._moduleHeight = this.rowHeight*this.rowNumber;
            },
        },
        created () {
